...
from api.repository import BrandRepository  # ProductRepository,
from api.repository import (CategoryRepository, PictureRepository,
                            SectionRepository, ShoppingCartRepository)
from api.serializers import (BrandSerializer, CategorySerializer,
                             PictureSerializer, SectionSerializer,
...
#         methods=['POST', 'DELETE'],
#         permission_classes=[IsOwnerFavoriteOrCart],
#         url_path=r'(?P<product_id>\d+)/(?P<quantity>\d+)
#         /shopping_cart/(?P<profile_id>\d+)',
#     )
#     def shopping_card(
#         self,
#         request: HttpRequest,
